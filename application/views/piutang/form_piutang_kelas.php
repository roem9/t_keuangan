...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="card shadow mb-4" style="max-width: 600px;">
      ...
      <div class="card-body">
            <form action="<?= base_url()?>piutang/addpiutangkelas" method="post">
                <!-- nama  -->
                ...
                <div class="form-group">
                    <label for="id_kelas">Nama Koor</label>
                    <select name="id_kelas" id="id_kelas" class="form-control form-control-sm" required>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#nip').change(function(){ 
            var nip=$(this).val();
            $.ajax({
                url : "<?=base_url()?>piutang/getKoorByPengajar",
                method : "POST",
                data : {nip: nip},
                async : true,
                dataType : 'json',
                success: function(data){
                    ...
                    for(i=0; i<data.length; i++){
                        html += '<option value='+data[i].id_kelas+'>'+data[i].nama_peserta+'</option>';
                    }
                    $('#id_kelas').html(html);
