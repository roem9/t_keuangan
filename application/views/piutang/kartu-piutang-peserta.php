                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url()?>kartupiutang/add_transaksi_langsung" method="POST" enctype="multipart/form-data" class="menu-navigation-3" id="menu-transaksi-langsung">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" class="form-control form-control-md" value="<?= $nama?>">
                                </div>
                                <div class="form-group">
                                    <label for="">Pembayaran Untuk?</label>
                                    <select name="keterangan" id="" class="form-control form-control-md" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominal" id="nominal_pembayaran" class="form-control form-control-md rupiah" required>
                                </div>
                            ...
                            <form action="<?= base_url()?>kartupiutang/add_piutang" method="POST" enctype="multipart/form-data" class="menu-navigation-3" id="menu-transaksi-piutang">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="ket" id="ket" class="form-control form-control-md" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominal" id="nominal_piutang" class="form-control form-control-md rupiah" required>
                                </div>
                                <div class="d-flex justify-content-end">
                            ...
                            <form action="<?=base_url()?>kartupiutang/add_pembayaran" method="post" enctype="multipart/form-data" class="menu-navigation-3" id="menu-pembayaran">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nominal" class="form-control form-control-md rupiah" required>
                                </div>
                                <div class="d-flex justify-content-end">
        ...
        <div class="modal-dialog modal-dialog-scrollable" role="document">
            ...
            <div class="modal-body cus-font">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nominal" id="nominal_uang" class="form-control form-control-md rupiah">
                </div>
                </div>
                <div class="modal-footer">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?= base_url()?>kartupiutang/edit_invoice" method="post"  class="menu-navigation-4" id="data-invoice-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="satuan" id="satuan_invoice" class="form-control form-control-md rupiah">
                                </div>
                                <div class="form-group">
                                    <label for="nominal">Nominal</label>
                                    <input type="text" name="nominal" id="nominal" class="form-control form-control-md rupiah">
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <?php if($detail['status'] == 'tagihan'):?>
                                            ...
                                            <?php if($detail['ket'] == "piutang"):?>
                                                <td>
                                                    <center>
                                                        <a onclick="return confirm('Yakin akan mengubah status piutang menjadi lunas?')" href="<?= base_url()?>kartupiutang/edit_status_piutang/<?= md5($detail['id_tagihan'])?>/lunas">
                                            ...
                                            <?php elseif($detail['ket'] == "lunas"):?>
                                                <td>
                                                    <center>
                                                        <a onclick="return confirm('Yakin akan mengubah status piutang menjadi piutang?')" href="<?= base_url()?>kartupiutang/edit_status_piutang/<?= md5($detail['id_tagihan'])?>/piutang">
